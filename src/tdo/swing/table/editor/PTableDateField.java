...
public class PTableDateField {
  public PTableDateField() {
  }
  PTableDateEditorSupport owner;
  ...
  public PTableDateField(char fieldID, String editMask, char fieldSeparator,
                    int order) {
...
//
  public void setOwner( PTableDateEditorSupport owner ) {
    this.owner = owner;
  }
  ...
  public PTableDateField previous() {
    if ( this.order == 0 )
      return this;
    return owner.getDateField()[ this.order-1 ];
  }
  public PTableDateField next() {
    if ( isLast()  )
      return this;
    return owner.getDateField()[ this.order+1 ];
  }
  ...
  public boolean check(KeyEvent e) {
    if ( newLength > maskLen ) {
      if ( isLast() )
        return false;
      PTableDateField nextField = owner.getDateField()[order+1];
      ...
      char[] newTextChars;//My 06.03.2012 = owner.getNewTextChars();
